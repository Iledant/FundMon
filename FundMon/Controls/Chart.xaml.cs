...
public sealed partial class Chart : UserControl
{
    ...
    public static readonly DependencyProperty ChartPaddingProperty =
        DependencyProperty.Register(
            nameof(ChartPadding),
            typeof(int),
            typeof(Chart), new PropertyMetadata(6));
    ...
    public static readonly DependencyProperty AxisTextSizeProperty =
        DependencyProperty.Register(nameof(AxisTextSize), typeof(int), typeof(Chart), new PropertyMetadata(12));
    ...
    public static readonly DependencyProperty InnerMarginProperty =
        DependencyProperty.Register(nameof(InnerMargin), typeof(int), typeof(Chart), new PropertyMetadata(3));
    ...
    public static readonly DependencyProperty IsAverageEnabledProperty =
        DependencyProperty.Register(nameof(IsAverageEnabled), typeof(bool), typeof(Chart), new PropertyMetadata(false));
    ...
    public static readonly DependencyProperty AverageCountProperty =
        DependencyProperty.Register(nameof(AverageCount), typeof(int), typeof(Chart), new PropertyMetadata(5));
    ...
    {
        _minVal = Values[0].Value;
        _maxVal = Values[0].Value;

        for (int i = 1; i < Values.Count; i++)
        {
            if (_minVal > Values[i].Value)
            {
                _minVal = Values[i].Value;
            }

            if (_maxVal < Values[i].Value)
            {
                _maxVal = Values[i].Value;
            }
        }
    }
